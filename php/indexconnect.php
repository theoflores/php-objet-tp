...
<div class="header"> 
       ...
       <button id="Inscription1"> <a id="pp" href="index.php" title="Deconnexion" style="text-decoration: none"> Se déconnecter </a></button>
</div>
        


<div id="navbar">
       <a class="active" href="indexconnect.php" title="Accueil" > Accueil </a> 
       <a href="javascript:void(0)">Race</a>
       <a href="javascript:void(0)" title="Adopte nous!" >Adopte nous !</a>
       <a href="javascript:void(0)">Support</a>
       <a onclick="document.getElementById('id01').style.display='block'" href="javascript:void(0)">Login</a>
       <a href="dashboard/index2.php">Dashboard Contact</a>
...
<div> <?php echo "Bonjour ".$_COOKIE['pseudo']; ?> </div>
